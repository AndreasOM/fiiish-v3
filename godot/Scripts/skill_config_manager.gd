...
func _init():
	...
	sc.add_level( 1, SkillLevelConfig.new( 1 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_EXPLOSION_COIN_PROBABILITY, 0.001 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_RAIN_COIN_PROBABILITY, 0.001 )
				)
	sc.add_level( 2, SkillLevelConfig.new( 5 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_EXPLOSION_COIN_PROBABILITY, 0.0025 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_RAIN_COIN_PROBABILITY, 0.0025 )
				)
	sc.add_level( 3, SkillLevelConfig.new( 10 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_EXPLOSION_COIN_PROBABILITY, 0.005 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_RAIN_COIN_PROBABILITY, 0.005 )
				)
	sc.add_level( 4, SkillLevelConfig.new( 25 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_EXPLOSION_COIN_PROBABILITY, 0.0075 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_RAIN_COIN_PROBABILITY, 0.0075 )
				)
	sc.add_level( 5, SkillLevelConfig.new( 100 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_EXPLOSION_COIN_PROBABILITY, 0.015 )
						.add_effect( SkillEffectIds.Id.COIN_RAIN_RAIN_COIN_PROBABILITY, 0.015 )
				)
	self.add( sc )
