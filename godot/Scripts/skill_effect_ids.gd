...
enum Id {
	...
	COIN_RAIN_RAIN_COIN_PROBABILITY = 13,
	COIN_RAIN_EXPLOSION_COIN_PROBABILITY = 14,
}
...
static func get_name_for_id( id: SkillEffectIds.Id ) -> String:
	match id:
		...
		SkillEffectIds.Id.COIN_RAIN_RAIN_COIN_PROBABILITY: 
			return "COIN_RAIN_RAIN_COIN_PROBABILITY"
		SkillEffectIds.Id.COIN_RAIN_EXPLOSION_COIN_PROBABILITY: 
			return "COIN_RAIN_EXPLOSION_COIN_PROBABILITY"
		_:
			return "[UNKNOWN]"
