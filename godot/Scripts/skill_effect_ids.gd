...
enum Id {
	...
	RAIN_COIN_PROBABILITY = 13,
	EXPLOSION_COIN_PROBABILITY = 14,
}
...
static func get_name_for_id( id: SkillEffectIds.Id ) -> String:
	match id:
		...
		SkillEffectIds.Id.RAIN_COIN_PROBABILITY: 
			return "RAIN_COIN_PROBABILITY"
		SkillEffectIds.Id.EXPLOSION_COIN_PROBABILITY: 
			return "EXPLOSION_COIN_PROBABILITY"
		_:
			return "[UNKNOWN]"
