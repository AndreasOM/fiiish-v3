...
make_variant() {
  ...
  # upscale to final
  gm convert "$small_tmp" -filter point -resize "$UPSCALE_PCT" "$final"
  crush_png "$final"
...
cp achievement_pal-bronze.png achievement_source_pal-bronze.png
